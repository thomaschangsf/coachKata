...
def get_onnx_model_info(onnx_session: ort.InferenceSession | None = None, onnx_path: str | Path | None = None) -> dict[str, Any]:
    """
...
def create_onnx_session_with_profiling(onnx_path: str | Path, profile_prefix: str = "onnx_profile") -> ort.InferenceSession:
    """
