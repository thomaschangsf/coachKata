...
try:
    import mediapipe as mp  # type: ignore[reportMissingTypeStubs]
...
class PoseComparator:
    ...
    def load_image(self, image_path: str) -> np.ndarray:
        ...
        """
        assert cv2 is not None  # Type guard
    ...
    def detect_pose(self, image: np.ndarray) -> list[tuple[float, float]] | None:
        """
